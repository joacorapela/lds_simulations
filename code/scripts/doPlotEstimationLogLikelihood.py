...
def main(argv):
    ...
    parser.add_argument("--filtering_results_true_params_filename", type=str,
                        default="../../results/81841842_filtered.pickle",
    ...
    filtering_results_true_params_filename = args.filtering_results_true_params_filename
    est_results_filename_pattern = args.est_results_filename_pattern
    fig_filename_pattern = args.fig_filename_pattern 

    with open(filtering_results_true_params_filename, "rb") as f:
        filtering_results_true_params = pickle.load(f)
    ...
    fig.add_trace(trace)
    fig.add_hline(y=filtering_results_true_params["filter_res"]["logLike"])
